  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed top-0 right-0 h-[calc(100vh-5rem)] w-80 md:w-96 bg-zinc-950/90 border-l border-white/5 backdrop-blur-xl shadow-2xl flex flex-col z-45 pt-16 select-none overflow-hidden"
      >
        {/* Header */}
